        ...
        <ul class="navbar-nav align-items-center ms-auto">
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            class="dropdown-notifications-item-icon bg-warning"
                        >
                    ...
                    >
                        ...
                        <div class="dropdown-notifications-item-content">
                            ...
                            <div
                                class="dropdown-notifications-item-content-text"
                            >
                                A new monthly report is ready. Click here to
                                view!
                            </div>
                        </div>
                    </a>
                    ...
                    >
                        <div
                            class="dropdown-notifications-item-icon bg-success"
                        >
                        ...
                        <div class="dropdown-notifications-item-content">
                            ...
                            <div
                                class="dropdown-notifications-item-content-text"
                            >
                                New user request. Woody has requested access to
                                the organization.
                            </div>
                        </div>
                    </a>
            ...
            <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                <a
                    ...
                    ><img
                        class="img-fluid"
                        src="../css/css/dist/assets/img/illustrations/profiles/profile-1.png"
                /></a>
                <div
                    class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
